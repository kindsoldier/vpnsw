...
pkgdatadir = $(datadir)/vpnsw
pkgincludedir = $(includedir)/vpnsw
pkglibdir = $(libdir)/vpnsw
pkglibexecdir = $(libexecdir)/vpnsw
...
CONFIG_CLEAN_FILES = vpnsw vpnsw.service rc.d/vpnsw init.d/vpnsw
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/vpnsw.pl \
	$(srcdir)/vpnsw.service.in $(top_srcdir)/init.d/vpnsw.in \
	$(top_srcdir)/rc.d/vpnsw.in config.guess config.sub install-sh \
	missing
...
ACLOCAL = ${SHELL} /home/ziggi/pmm2/mojoapps/bird/vpnsw/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
APP_USER = root
AUTOCONF = ${SHELL} /home/ziggi/pmm2/mojoapps/bird/vpnsw/missing autoconf
AUTOHEADER = ${SHELL} /home/ziggi/pmm2/mojoapps/bird/vpnsw/missing autoheader
AUTOMAKE = ${SHELL} /home/ziggi/pmm2/mojoapps/bird/vpnsw/missing automake-1.15
AWK = gawk
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"vpnsw.pl\" -DPACKAGE_TARNAME=\"vpnsw-pl\" -DPACKAGE_VERSION=\"0.02\" -DPACKAGE_STRING=\"vpnsw.pl\ 0.02\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"vpnsw-pl\" -DVERSION=\"0.02\" -DAPP_CONFDIR=\"/usr/local/etc/vpnsw\" -DAPP_LOGDIR=\"/var/log/vpnsw\" -DAPP_RUNDIR=\"/var/run/vpnsw\" -DAPP_USER=\"root\" -DAPP_GROUP=\"wheel\" -DAPP_LIBDIR=/usr/local/share/vpnsw
ECHO_C = 
ECHO_N = -n
ECHO_T = 
HAVE_PERL = true
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/ziggi/pmm2/mojoapps/bird/vpnsw/missing makeinfo
MKDIR_P = /usr/local/bin/gmkdir -p
PACKAGE = vpnsw
PACKAGE_BUGREPORT = 
PACKAGE_NAME = vpnsw.pl
PACKAGE_STRING = vpnsw.pl 0.02
PACKAGE_TARNAME = vpnsw-pl
PACKAGE_URL = 
...
STRIP = 
VERSION = 0.02
abs_builddir = /home/ziggi/pmm2/mojoapps/bird/vpnsw
abs_srcdir = /home/ziggi/pmm2/mojoapps/bird/vpnsw
abs_top_builddir = /home/ziggi/pmm2/mojoapps/bird/vpnsw
abs_top_srcdir = /home/ziggi/pmm2/mojoapps/bird/vpnsw
am__leading_dot = .
...
install_sh = ${SHELL} /home/ziggi/pmm2/mojoapps/bird/vpnsw/install-sh
...
$(am__aclocal_m4_deps):
vpnsw: $(top_builddir)/config.status $(srcdir)/vpnsw.pl
	cd $(top_builddir) && $(SHELL) ./config.status $@
vpnsw.service: $(top_builddir)/config.status $(srcdir)/vpnsw.service.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
rc.d/vpnsw: $(top_builddir)/config.status $(top_srcdir)/rc.d/vpnsw.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
init.d/vpnsw: $(top_builddir)/config.status $(top_srcdir)/init.d/vpnsw.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
install-data-am: install-dist_confDATA install-nobase_dist_pkgdataDATA \
	install-nobase_etcSCRIPTS install-nobase_systemdDATA
	@$(NORMAL_INSTALL)
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	uninstall-dist_confDATA uninstall-nobase_dist_pkgdataDATA \
	uninstall-nobase_etcSCRIPTS uninstall-nobase_systemdDATA \
	uninstall-sbinSCRIPTS
